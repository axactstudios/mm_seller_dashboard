...
import 'package:mm_seller_dashboard/exceptions/firebaseauth/reauth_exceptions.dart';
...
class AuthenticationService {
  ...
  void setLocalAuthStatus(String status) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future<bool> signUp(
    ...
    try {
      ...
      await UserDatabaseHelper().createNewUser(uid, email, phone, name);
      return true;
    } on MessagedFirebaseAuthException {
      rethrow;
    } on FirebaseAuthException catch (e) {
